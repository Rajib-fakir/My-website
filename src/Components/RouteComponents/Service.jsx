  ...
  const services = [
    {
      ...
      icon: "bi-code-slash",
      desc: "Custom websites and web apps built with modern frameworks. We ensure fast, secure, and scalable digital experiences.",
    },
    {
      title: "UI/UX Design",
      icon: "bi-palette",
      desc: "We design intuitive user interfaces and seamless user experiences that make your brand stand out.",
    },
    {
